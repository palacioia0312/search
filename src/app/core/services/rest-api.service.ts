...
export class restApiService {
	...
	deleteCustomer(id: any): Observable<any> {
		...
		return this.http.delete(
			GlobalComponent.API_URL + "apps/customer/" + id,
			{ headers: headerToken, responseType: "text" }
		);
	}
	...
	deleteContact(id: any): Observable<any> {
		...
		return this.http.delete(
			GlobalComponent.API_URL + "apps/contact/" + id,
			{ headers: headerToken, responseType: "text" }
		);
	}
	...
	deleteCompany(id: any): Observable<any> {
		...
		return this.http.delete(
			GlobalComponent.API_URL + "apps/company/" + id,
			{ headers: headerToken, responseType: "text" }
		);
	}
	...
	deleteInvoice(id: any): Observable<any> {
		...
		return this.http.delete(
			GlobalComponent.API_URL + "apps/invoice/" + id,
			{ headers: headerToken, responseType: "text" }
		);
	}
}
